...
import { Disposable, DisposableCollection, MaybePromise } from '@malagu/core';
...
export const DISABLED_CLASS = 'malagu-mod-disabled';
export const EXPANSION_TOGGLE_CLASS = 'malagu-ExpansionToggle';
export const COLLAPSED_CLASS = 'malagu-mod-collapsed';
export const SELECTED_CLASS = 'malagu-mod-selected';
export const FOCUS_CLASS = 'malagu-mod-focus';
