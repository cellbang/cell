import { HandlerAdapter } from './dispatcher-protocol';
import { Component, Autowired } from '../../common/annotation';
import { ChannelManager } from './channel-manager';
import { Context } from './context';
import { Value } from '../../common/annotation/detached';
import { StrOrRegex, MethodMetadata } from '../annotation/method';
import { RouteBuilder } from './route-builder';
import { ViewResolver } from './resolver/resolver-protocol';
import { ResponseResolverProvider } from './resolver/response-resolver-provider';
import { MethodArgsResolverProvider } from './resolver/method-args-resolver-provider';
        ...
        if (pathMap) {
            for (const entry of pathMap) {
                ...
                if (pathParams) {
                    ...
                    await ctx.handleMessage(ctx.response.body);
                    return;
                }
            }
        }
