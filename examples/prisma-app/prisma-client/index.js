...
const foundDirname = !regularDirname && findSync(process.cwd(), [
    "examples/prisma-app/prisma-client",
    "prisma-app/prisma-client",
], ['d'], ['d'], 1)[0]
...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/kevin/code/malagu/examples/prisma-app/prisma-client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
...
path.join(process.cwd(), "examples/prisma-app/prisma-client/libquery_engine-darwin.dylib.node")

path.join(__dirname, "libquery_engine-rhel-openssl-1.0.x.so.node");
path.join(process.cwd(), "examples/prisma-app/prisma-client/libquery_engine-rhel-openssl-1.0.x.so.node")
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "examples/prisma-app/prisma-client/schema.prisma")
