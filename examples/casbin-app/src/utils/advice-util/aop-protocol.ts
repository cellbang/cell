import { ComponentMetadata } from '@malagu/core';
import { Newable } from '@malagu/core';

export const AOP_TAG = 'AOP_TAG';

export const AroundAdvice = Symbol('AroundAdvice');
...
export interface AfterThrowsAdvice extends AfterAdvice {
    ...
    afterThrows(returnValue: any, error: any, method: string | number | symbol, args: any[], target: any): Promise<void>;
