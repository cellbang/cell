export const templates: any = {
    ...
    'vercel-sample-app': '{{ templatePath }}/vercel/sample-app',
    'vercel-backend-app': '{{ templatePath }}/vercel/backend-app',
    'vercel-database-app': '{{ templatePath }}/vercel/database-app',
    'vercel-multi-component': '{{ templatePath }}/vercel/multi-component',
